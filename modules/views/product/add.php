                ...
                <div class="row-fluid form-wrapper">
                    ...
                    <div class="span9 with-sidebar">
                        <div class="container">
                                ...
                                echo $form->field($model, 'cateid')->dropDownList($opts, ['id' => 'cates','class'=>'span6']);
                                echo $form->field($model, 'title')->textInput(['class' => 'span9']);
                                echo $form->field($model, 'desc')->textarea(['id' => "wysi", 'class' => "span9 wysihtml5", 'style' => 'margin-left:120px']);
                                ...
                                echo $form->field($model, 'cover')->fileInput(['class' => 'span9','value'=>'']);
