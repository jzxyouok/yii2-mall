    ...
    <div class="row-fluid login-wrapper">
        ...
        <div class="span4 box">
            <div class="content-wrap">
                ...
                <?php echo $form->field($model,'userpass')->passwordInput(['class'=>'span12','placeholder'=>"设置密码"]) ?>
                <?php echo $form->field($model,'repass')->passwordInput(['class'=>'span12','placeholder'=>"确认密码"]) ?>
                <a href="<?php echo yii\helpers\Url::to(['member/mailchangepass']) ?>" class="forgot">返回登录</a>
