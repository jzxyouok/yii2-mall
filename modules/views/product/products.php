                ...
                <div class="row-fluid table">
                    <table class="table table-hover">
                        ...
                        <tr class="first">
                            ...
                            <a href="<?php echo yii\helpers\Url::to(['product/position', 'productid' => $product->productid]); ?>">推荐</a>
                            <a href="<?php echo yii\helpers\Url::to(['product/edit', 'productid' => $product->productid]); ?>">编辑</a>
