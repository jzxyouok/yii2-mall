    ...
    <?php foreach($this->params['menu'] as $top ): ?>
        ...
        <div class="row">
            <div class="col-xs-12 col-lg-4">
                ...
                <?php foreach($top['children'] as $k => $v): ?>
                    <li><a href=" <?php echo yii\helpers\Url::to(['product/index','cateid'=>$v['cateid']]) ?> "> <?php echo $v['title'] ?> </a></li>
                <?php endforeach;?>
                <?php }else{ ?>
                    <li><a href=" <?php echo yii\helpers\Url::to(['product/index','cateid'=>$top['cateid']]) ?> "> <?php echo $top['title'] ?> </a></li>
                <?php }?>
                </ul>
            </div>
...
<div id="hero">
    <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
        <?php foreach($position['topPos'] as $v): ?>
        <div class="item" style="background-image: url('http://<?php echo $v['cover'] ?>');">
            <div class="container-fluid">
                <div class="caption vertical-center text-left">
                    ...
                    <div class="button-holder fadeInDown-3">
                        <a href="<?php echo yii\helpers\Url::to(['product/detail','productid'=>$v['productid']]) ?>" class="big le-button ">去购买</a>
                    </div>
                </div><!-- /.caption -->
            </div><!-- /.container-fluid -->
        </div><!-- /.item -->
                ...
                <div class="tab-pane active" id="featured">
                    ...
                    <?php foreach($position['tui'] as $v): ?>
                        <div class="col-sm-4 col-md-3 no-margin product-item-holder hover">
                            ...
                            <?php endif;?>
                            <?php if($v['istui']==1): ?>
                                <div class="ribbon blue"><span>push!</span></div> 
                            <?php endif;?>
                                <div class="image">
                                    <img alt="" src="http://<?php echo $v['cover'] ?>"  />
                                </div>
                                <div class="body">
                                    <div class="label-discount clear"></div>
                                    <div class="title">
                                        <a href="<?php echo yii\helpers\Url::to(['product/detail','productid'=>$v['productid']]) ?>"><?php  echo $v['title'] ?></a>
                                    </div>
                                </div>
                                <div class="prices">
                                    <div class="price-prev">￥<?php echo $v['price'] ?></div>
                                    <div class="price-current pull-right">￥<?php echo $v['saleprice'] ?></div>
                                </div>
