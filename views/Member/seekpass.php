    ...
    <div class="row-fluid login-wrapper">
        ...
        <div class="span4 box">
            <div class="content-wrap">
                <h6>慕课商城 - 找回密码</h6>
                <?php echo $form->field($model,'username')->textInput(['class'=>'span12','placeholder'=>"账号"]) ?>
                <?php echo $form->field($model,'useremail')->textInput(['class'=>'span12','placeholder'=>"邮箱"]) ?>
               
                <?php echo Html::submitButton('提交',['class'=> 'btn-glow primary login']) ?>
            </div>
        </div>
        <?php ActiveForm::end() ?>
    </div>
