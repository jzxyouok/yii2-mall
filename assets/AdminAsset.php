...
class AdminAsset extends AssetBundle
{
    ...
    public function registerAssetFiles($view){
        $this->css = [
            ...
            'admin/css/icons.css',
            ['admin/css/compiled/index.css','media'=>'screen'],
            'admin/css/lib/bootstrap-wysihtml5.css',
            ['admin/css/compiled/form-showcase.css','media'=>'screen'],
        ...
        $this->js = [
            ...
            ['http://html5shim.googlecode.com/svn/trunk/html5.js','condition'=>'let IE9','position'=>\yii\web\View::POS_HEAD],
        ];
