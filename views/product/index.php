            ...
            <div class="row">
                <div class="col-xs-4 col-sm-4 no-margin">
                    <a href="#" class="thumb-holder">
                        <img alt="" src="assets/images/blank.gif" data-echo=" http://<?php echo $v['cover'] ?> " />
                    </a>
                </div>
                <div class="col-xs-8 col-sm-8 no-margin">
                    <a href="<?php echo yii\helpers\Url::to(['product/detail','productid'=>$v['productid']]) ?>"><?php echo $v['title'] ?></a>
                        <div class="price">
                            ...
                            <div class="price-current"><?php echo $v['saleprice'] ?> </div>
                        </div>
                </div>  
            </div>
        </li>
    ...
    <?php foreach($all as $k => $v): ?>
        <div class="no-margin carousel-item product-item-holder hover size-medium">
            <div class="product-item">
                ...
                <div class="prices">
                    <div class="price-current text-right"><?php echo $v['saleprice'] ?></div>
                </div>
                <div class="hover-area">
                    <div class="add-cart-button">
                        <a href="<?php echo yii\helpers\Url::to(['cart/add','productid'=>$v['productid']]) ?>" class="le-button">add to cart </a>
                    </div>
